...
const navIcons = [
  {
    id: 1,
    img: toAssetPath("/icons/wifi.svg"),
  },
  {
    id: 2,
    img: toAssetPath("/icons/search.svg"),
  },
  {
    id: 3,
    img: toAssetPath("/icons/user.svg"),
  },
  {
    id: 4,
    img: toAssetPath("/icons/mode.svg"),
  },
];
...
const blogPosts = [
  {
    ...
    image: toAssetPath("/images/blog1.png"),
  ...
  },
  {
    ...
    image: toAssetPath("/images/blog2.png"),
  ...
  },
  {
    ...
    image: toAssetPath("/images/blog3.png"),
...
const socials = [
  {
    id: 1,
    text: "Github",
    icon: toAssetPath("/icons/github.svg"),
    bg: "#f4656b",
  ...
  },
  {
    id: 2,
    text: "Platform",
    icon: toAssetPath("/icons/atom.svg"),
    bg: "#4bcb63",
  ...
  },
  {
    id: 3,
    text: "Twitter/X",
    icon: toAssetPath("/icons/twitter.svg"),
    bg: "#ff866b",
  ...
  },
  {
    id: 4,
    text: "LinkedIn",
    icon: toAssetPath("/icons/linkedin.svg"),
    bg: "#05b6f6",
...
const photosLinks = [
  {
    id: 1,
    icon: toAssetPath("/icons/gicon1.svg"),
    title: "Library",
  },
  {
    id: 2,
    icon: toAssetPath("/icons/gicon2.svg"),
    title: "Memories",
  },
  {
    id: 3,
    icon: toAssetPath("/icons/file.svg"),
    title: "Places",
  },
  {
    id: 4,
    icon: toAssetPath("/icons/gicon4.svg"),
    title: "People",
  },
  {
    id: 5,
    icon: toAssetPath("/icons/gicon5.svg"),
    title: "Favorites",
  },
];
...
const gallery = [
  {
    id: 1,
    img: toAssetPath("/images/gal1.png"),
  },
  {
    id: 2,
    img: toAssetPath("/images/gal2.jpg"),
  },
  {
    id: 3,
    img: toAssetPath("/images/gal4.png"),
  },
  {
    id: 4,
    img: toAssetPath("/images/gal3.png"),
  },
];
...
const WORK_LOCATION = {
  ...
  type: "work",
  name: "Work",
  icon: toAssetPath("/icons/work.svg"),
  kind: "folder",
  children: [
    // ▶ Project 1
    {
      ...
      icon: toAssetPath("/images/folder.png"),
      kind: "folder",
      ...
      children: [
        {
          id: 1,
          name: "$pendr.txt",
          icon: toAssetPath("/images/txt.png"),
          kind: "file",
          fileType: "txt",
        ...
        },
        {
          id: 2,
          name: "$pendr.com",
          icon: toAssetPath("/images/safari.png"),
          kind: "file",
          fileType: "url",
        ...
        },
        {
          id: 4,
          name: "$pendr.png",
          icon: toAssetPath("/images/image.png"),
          kind: "file",
          fileType: "img",
          position: "top-52 right-80",
          imageUrl: toAssetPath("/images/spendr.png"),
        },
        {
          id: 5,
          name: "Github",
          icon: toAssetPath("/images/plain.png"),
          kind: "file",
          fileType: "fig",
    ...
    // ▶ Project 2
    {
      ...
      children: [
        ...
        },
        {
          ...
          imageUrl: toAssetPath("/images/ERP-KPI.png"),
        },
        {
          id: 5,
          name: "Github",
    ...
    // ▶ Project 3
    {
      ...
      children: [
        ...
        },
        {
          ...
          fileType: "img",
          position: "top-52 right-80",
          imageUrl: toAssetPath("/images/CNNArch.png"),
        },
        {
          id: 5,
          name: "Github",
...
const ABOUT_LOCATION = {
  ...
  type: "about",
  name: "About me",
  icon: toAssetPath("/icons/info.svg"),
  kind: "folder",
  children: [
    {
      id: 1,
      ...
      imageUrl: toAssetPath("/images/shaurya.png"),
    },
    {
      id: 2,
      name: "casual-me.png",
      ...
      imageUrl: toAssetPath("/images/shaurya-2.png"),
    },
    {
      id: 3,
      ...
      fileType: "img",
      position: "top-52 left-80",
      imageUrl: toAssetPath("/images/shaurya-3.png"),
    },
    {
      id: 4,
      name: "about-me.txt",
      ...
      image: toAssetPath("/images/shaurya-4.png"),
      description: [
  ...
  children: [
    {
      id: 1,
      name: "Resume.pdf",
      icon: toAssetPath("/images/pdf.png"),
      kind: "file",
      fileType: "pdf",
...
const TRASH_LOCATION = {
  ...
  type: "trash",
  name: "Trash",
  icon: toAssetPath("/icons/trash.svg"),
  kind: "folder",
  children: [
    {
      id: 1,
      ...
      imageUrl: toAssetPath("/images/trash-1.png"),
    },
    {
      id: 2,
      name: "trash2.png",
      ...
      imageUrl: toAssetPath("/images/trash-2.png"),
    },
  ],
};
